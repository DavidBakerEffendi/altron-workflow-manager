...
import { DACComponent } from 'app/entities/dac/dac.component';
import { DACService } from 'app/entities/dac/dac.service';
import { DAC } from 'app/shared/model/dac.model';

describe('Component Tests', () => {
    describe('DAC Management Component', () => {
        let comp: DACComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.dACS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
