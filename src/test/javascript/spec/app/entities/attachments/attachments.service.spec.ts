...
import { IAttachments, Attachments } from 'app/shared/model/attachments.model';
...
describe('Service Tests', () => {
    describe('Attachments Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Attachments(0, 'AAAAAAA', 'AAAAAAA');
        });
