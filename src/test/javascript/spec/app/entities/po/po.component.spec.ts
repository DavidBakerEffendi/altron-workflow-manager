...
import { POComponent } from 'app/entities/po/po.component';
import { POService } from 'app/entities/po/po.service';
import { PO } from 'app/shared/model/po.model';

describe('Component Tests', () => {
    describe('PO Management Component', () => {
        let comp: POComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.pOS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
