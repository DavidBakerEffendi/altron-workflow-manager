...
import { IMilestone, Milestone, MilestoneStatus } from 'app/shared/model/milestone.model';
...
describe('Service Tests', () => {
    describe('Milestone Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Milestone(0, 'AAAAAAA', currentDate, 0, 0, 0, 0, MilestoneStatus.ACTIVE);
        });
                ...
                const returnedFromService = Object.assign(
                    {
                        ...
                        dueDate: currentDate.format(DATE_TIME_FORMAT),
                        previousRevenue: 1,
                        prereceiptedIncome: 1,
                        revenueHoldBack: 1,
                        revenueInNextFinYear: 1,
                        status: 'BBBBBB'
                    },
                    elemDefault
                );
