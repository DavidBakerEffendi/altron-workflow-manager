...
import com.altron.workflowmanager.domain.Contact;
import com.altron.workflowmanager.repository.ContactRepository;
...
public class ContactResourceIntTest {
    ...
    private static final String DEFAULT_WORK_NUMBER = "AAAAAAAAAAAA";
    private static final String UPDATED_WORK_NUMBER = "BBBBBBBBBBBB";

    private static final String DEFAULT_CELL_NUMBER = "AAAAAAAAAAAA";
    private static final String UPDATED_CELL_NUMBER = "BBBBBBBBBBBB";
    ...
    public void createContact() throws Exception {
        ...
        assertThat(testContact.getWorkNumber()).isEqualTo(DEFAULT_WORK_NUMBER);
        assertThat(testContact.getCellNumber()).isEqualTo(DEFAULT_CELL_NUMBER);
    ...
    public void getAllContacts() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].workNumber").value(hasItem(DEFAULT_WORK_NUMBER.toString())))
            .andExpect(jsonPath("$.[*].cellNumber").value(hasItem(DEFAULT_CELL_NUMBER.toString())))
    ...
    public void getContact() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts/{id}", contact.getId()))
            ...
            .andExpect(jsonPath("$.workNumber").value(DEFAULT_WORK_NUMBER.toString()))
            .andExpect(jsonPath("$.cellNumber").value(DEFAULT_CELL_NUMBER.toString()))
    ...
    public void updateContact() throws Exception {
        ...
        assertThat(testContact.getWorkNumber()).isEqualTo(UPDATED_WORK_NUMBER);
        assertThat(testContact.getCellNumber()).isEqualTo(UPDATED_CELL_NUMBER);
